...
@section('content')
    <div class="max-w-2xl mx-auto bg-white p-8 rounded shadow">
        ...
        <form id="step3-form" method="POST" action="{{ url('/step-3') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="fgis_number" class="block text-sm font-medium text-gray-700 mb-5 flex items-center">
                        ФГИС лицензия *
                ...
                <div>
                    <label for="fgis_date" class="block text-sm font-medium text-gray-700 mb-5 flex items-center">
                        Дата выдачи ФГИС *
